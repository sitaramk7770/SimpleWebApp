...
<body>
    ...
    <section id="home">
        <header>
            <span style="font-size:64px;margin-right:10px;color:orange">London Shopping sale Website</span>
            <ul id="menu">
         ...
         <h1>Flipkart summer Mobile offer available from 1st May 2023 31st May 2023</h1>
    </section>    
